...
export function useSupermarketFindMany<
...
>(
  ...
  const roq = useRoqClient();
  const key = JSON.stringify(['useSupermarketFindMany', args || {}]);
  return useSWR<R, Error>(
    key,
    async () => {
      const result = await roq.supermarket.findMany(args, options);
      return result as R;
    },
    {
      ...swrOptions,
...
export function useSupermarketCount<T extends Prisma.supermarketCountArgs, R extends number>(
  args?: Prisma.SelectSubset<T, Prisma.supermarketCountArgs>,
  options?: RequestOptions,
  swrOptions?: SWRRequestOptions<R>,
) {
  const roq = useRoqClient();
  const key = JSON.stringify(['useSupermarketCount', args || {}]);
  return useSWR<R, Error>(
    key,
    async () => {
      const result = await roq.supermarket.count(args, options);
      return result as R;
    },
    {
      ...swrOptions,
...
export function useSupermarketFindManyWithCount<
  T extends Prisma.supermarketFindManyArgs,
  R extends { data: GetFindResult<Prisma.$supermarketPayload<DefaultArgs>, T>[]; count: number },
>(
  args?: Prisma.SelectSubset<T, Prisma.supermarketFindManyArgs>,
  options?: RequestOptions,
  swrOptions?: SWRRequestOptions<R>,
  ...
  const roq = useRoqClient();
  const key = JSON.stringify(['useSupermarketFindManyWithCount', args || {}]);
  return useSWR<R, Error>(
    key,
    async () => {
      const result = await roq.supermarket.findManyWithCount(args, options);
      return result as R;
    },
    {
      ...swrOptions,
...
export function useSupermarketFindFirst<
...
>(
  ...
  const roq = useRoqClient();
  const key = JSON.stringify(['useSupermarketFindFirst', args || {}]);
  return useSWR<R, Error>(
    key,
    async () => {
      const result = await roq.supermarket.findFirst(args, options);
      return result as R;
    },
    {
      ...swrOptions,
